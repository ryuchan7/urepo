<?php 
$user = $conn->query("SELECT * FROM lecturer_list where id ='".$_settings->userdata('id')."'");
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label for="firstname" class="control-label text-sm">Full Name</label>
							<input type="text" name="fullname" id="fullname" autofocus class="form-control form-control-sm form-control-border" value="<?= isset($fullname) ? $fullname : '' ?>" required="required">
						</div>
					</div>
					<div class="col-md-4">
				<div class="row">
