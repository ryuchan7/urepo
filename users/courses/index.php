...
<div class="card card-outline rounded-0 card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Programme</h3>
        <?php if($_settings->userdata('type') == 'admin'): // Only show the button to admin ?>
        ...
        <div class="container-fluid">
            <table class="table table-hover table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $qry = $conn->query("SELECT * from `programme_list` where delete_flag = 0 order by `name` asc ");
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <?php if($_settings->userdata('type') == 'admin'): // Only show edit and delete options to admin ?>
...
<script>
    $(document).ready(function(){
        ...
        <?php if($_settings->userdata('type') == 'admin'): // Only add this functionality for admin ?>
        $('#create_new').click(function(){
            uni_modal("<i class='fa fa-plus'></i> Add New Programme","courses/manage_course.php")
        })
