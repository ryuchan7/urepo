        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT c.*, cc.name as `course`, c.course_code from `course_list` c inner join `programme_list` cc on c.course_id = cc.id where c.delete_flag = 0 and c.user_id = '{$_settings->userdata('id')}' order by cc.`name` asc, c.`name` asc ");
...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add New Courses","classes/manage_class.php")
		})
