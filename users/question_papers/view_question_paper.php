...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT q.*, CONCAT(cc.name,' - ',c.name) as `class`, c.course_code FROM `question_paper_list` q INNER JOIN course_list c ON q.class_id = c.id INNER JOIN programme_list cc ON c.course_id = cc.id WHERE q.id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
    ...
    <div class="card card-outline card-primary shadow rounded-0">
        ...
        <div class="card-body">
            <div class="container-fluid">
                <dl>
                    <dt class="text-muted">Programme/Course</dt>
                    ...
                    <dd class="pl-4"><?= isset($course_code) ? $course_code : '' ?></dd>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Objective Question</span>
                    ...
                    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Text Question</span>
                                <span class="info-box-number text-right">
                                <?php 
                ...
                <?php if(isset($_GET['type'])): ?>
                    <?php $type_arr = ['','Obejective Question','True/False Question','Text Question'] ?>
