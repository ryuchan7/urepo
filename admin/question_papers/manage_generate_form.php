	...
	<form action="./?page=question_papers/generated_question_paper" method="POST" id="type-form">
		<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
		    <div class="form-group">
                <label for="single" class="control-label">No. of Objective Questions to Generate</label>
            ...
            <div class="form-group">
                <label for="multiple" class="control-label">No. of True/False Questions to Generate</label>
            ...
            <div class="form-group">
                <label for="text" class="control-label">No. of Text Questions to Generate</label>
